...
| **DALI** | GPU-accelerated data loading and processing with NVIDIA DALI. | 0 | [`skills/DALI/`](skills/DALI) | [Source](https://github.com/NVIDIA/DALI/tree/main/.agents/skills) | [`93b9a59`](https://github.com/NVIDIA/DALI/commit/93b9a59b2d484b96d3590bf9c3f559150ccaf60c) · 2026-05-27 |
...
| **NeMo Gym** | RL training environments — add benchmarks, resources servers, agent wiring, and reward profiling. | 0 | [`skills/NeMo-Gym/`](skills/NeMo-Gym) | [Source](https://github.com/NVIDIA-NeMo/Gym/tree/main/.claude/skills) | [`545a07a`](https://github.com/NVIDIA-NeMo/Gym/commit/545a07a59c90b61c2eaeb382505b79fc81a1f562) · 2026-05-26 |
| **NeMo-RL** | RLHF training on Ray — GRPO, DPO, and SFT for LLMs and VLMs with FSDP2 and Megatron-Core. | 0 | [`skills/NeMo-RL/`](skills/NeMo-RL) | [Source](https://github.com/NVIDIA-NeMo/RL/tree/main/skills) | [`c3bb1d7`](https://github.com/NVIDIA-NeMo/RL/commit/c3bb1d787365ecf4f0af48a6463b34bf9eff59af) · 2026-05-27 |
